        ...
        <div class="card">
            <div class="row align-items-center">
                <div class="col-xs-12 col-sm-6 text-center p-5">
                    <img class="blank-image" src="http://acc.syssolution.com.bd/public/img/empty_pages/revenues.png" alt="Revenues"/>
                </div>
                <div class="col-xs-12 col-sm-6 text-center p-5">
                    <p class="text-justify description">
                        Revenue is a paid income transaction. It can be an independent record (i.e. deposit) or attached to an invoice.
                    </p>
                    <a href="http://acc.syssolution.com.bd/1/sales/revenues/create" class="btn btn-success float-right mt-4"><span class="btn-inner--text">Create Revenue</span></a>
                </div>
            </div>
        </div>
    @endif
